...
public class CreacionActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener  {
    ...
    private void guardarXML() {
        try {
            CheckXML.crearXML(listaNoticias, TEMPORAL);
